  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          { icon: Users, label: t('totalStaff'), value: initialStaff.length, color: 'text-primary', bg: 'bg-primary/10', trend: '+2 this month' },
        ...
        <AnimatePresence mode="popLayout">
          {filtered.map((member, i) => (
            <motion.div
              ...
              className="group bg-white dark:bg-white/5 rounded-[32px] p-2 flex flex-col border border-slate-100 dark:border-white/5 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500"
            >
