        ...
        {data.length > 0 ? (
          data.map((item, i) => (
            <div key={item.name} className="flex items-center gap-3 group">
              <span className="text-xl w-8 text-center bg-white/5 h-10 w-10 flex items-center justify-center rounded-xl border border-white/5 group-hover:border-primary/50 transition-colors">
                {item.emoji}
              </span>
