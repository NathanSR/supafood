...
export default function SettingsPage() {
  ...
  // Mock initial data (should ideally come from server in a real app)
  const initialProfile = { fullName: 'John Manager', avatarUrl: '' };
  ...
  const renderContent = () => {
    switch (activeSection) {
      case 'profile':
        return <ProfileSection initialData={initialProfile} onUpdateProfile={handleUpdateProfile} onUpdatePassword={handleUpdatePassword} />;
      case 'restaurant':
        return <RestaurantSection initialData={initialRestaurant} onUpdate={handleUpdateRestaurant} />;
      case 'notifications':
        return <NotificationsSection />;
      case 'appearance':
        return <AppearanceSection currentLocale={locale as string} />;
      case 'billing':
